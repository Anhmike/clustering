...
cure.clust:{[sample;numR;com;diml;kd]
 ...
 recalc:tree.distC[;;edist2]/[clustD;exec idx from clustD where initi in j0,valid]; /recalc the new distances of pts who use to have the rep pts as their closestidx
...
cure.cure:{[sample;numR;com;numCl]
 ...
 cureTab:{[numCl;kd](count distinct(select from kd where valid)`clust)>numCl}[numCl] cure.clust[sample;numR;com;diml]/tree.createTree[sample;diml;edist2];
