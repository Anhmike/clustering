...
cure.clust:{[sample;numR;com;diml;kd]
 ...
 deleteClust:kd.deleteN/[kd;idxs]; /delete the closest points from the tree
 ...
 insertCl:kd.insertKd[diml]/[deleteClust;rep;sami;first idxs]; / insert the new rep pts into the tree
